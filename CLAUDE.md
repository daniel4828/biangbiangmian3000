...
| R14 | **Opus 编排，Sonnet 执行** | （2026-08-14 起，由 Daniel 决定）主会话是编排者：读代码、定方案、写施工图、审查结果、跑 Git/gh 流程；**实现代码派给 Sonnet 子代理**，类型固定用 `implementer`（#1021，工具表里没有 Bash，物理上碰不了 Git）。见"代理编排"章节 |
